...
@FacesConverter(value = "tipomovimientoConverter")
public class TipomovimientoConverter implements Converter {

    private TipomovimientoFacade ejbFacade;
    ...
    private TipomovimientoFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(TipomovimientoFacade.class).get();
